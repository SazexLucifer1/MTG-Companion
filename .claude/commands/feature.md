...
1. Bestimme über die Architektur-Karte in `CLAUDE.md`, welche Dateien betroffen sind — Komponente, Service, `models.ts`, `i18n.service.ts`, ggf. `sql/` und `public/_headers`.
...
- Alle sichtbaren Texte über `i18n.service.ts`, in **beiden** Sprachen — nichts fest ins Template schreiben.
